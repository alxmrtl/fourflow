# Grounding Values - Pinned Essential Article
...
Your values are like a mountain in a storm—everything else might shift, but they remain steady.
...
## Related Keys
Clear Mission provides actionable expression of your values through concrete goals. Ignited Curiosity often emerges when exploring things aligned with your values. Visualized Vision translates abstract values into concrete future outcomes.