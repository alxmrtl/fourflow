...
const SetupSpirit = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div>
        <h2 className="text-xl font-semibold text-spirit">SPIRIT - Know Your Why</h2>
      ...
      <div className="space-y-1">
        <h3 className="text-base font-semibold text-spirit">Vision</h3>
        <textarea
          value={vision}
