...
const About = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 pb-24 md:pb-6 space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-display font-bold text-gray-800">About FlowZone</h1>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">What is FlowZone?</h2>
        <p className="text-gray-700 leading-relaxed">
          FlowZone is a productivity app designed to help you build deep focus by tracking your
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          when your mind wants to escape. That's what FlowZone helps you develop.
        </p>
      </div>
      ...
      <div className="text-center text-sm text-gray-500 space-y-1">
        ...
        <p>© 2025 FlowZone. All rights reserved.</p>
