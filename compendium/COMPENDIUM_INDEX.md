# Compendium Retrieval Index

Agent-readable flat map. Scan this first, then read only the file(s) you need.
...
## Concepts
`compendium/framework/_concepts/`

| File | Core idea |
|------|-----------|
| `soul.md` | The observer/witness dimension — SOUL as the light source; four pillars as lens; heart as the iris mechanism |
| `conscious-accomplishment.md` | Integration of flow psychology with conscious intention |

---

## Captures
`compendium/framework/_captures/`

| File | Source | Relevant keys |
|------|--------|---------------|
| `koe-extreme-focus-article.md` | Dan Koe article on extreme focus | Open Mind, Intentional Space |
| `doris-minimalism-flow-article.md` | Article on minimalism as flow enabler | Intentional Space, Optimized Tools |
