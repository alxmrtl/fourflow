...
keywords: [discovery, novelty, optimization, openness, seeking]
definition: "Encourages discovery over optimization."
tags:
  - type/quality
---
...
- [[playfulness]] — playfulness is exploration bias with threat-perception lowered; the two compound
- [[growth-orientation]] — exploration without growth orientation is diffuse; growth orientation gives exploration the right target

## Sources
- *needs sources*

## Recall
**Hook**: Optimization refines what's known. Exploration finds what isn't. Flow requires both — but most people over-index on the former.
**Mechanism**: An exploration bias keeps the system oriented toward challenge and novelty, which are the primary conditions for sustaining the flow channel over time; pure optimization eliminates them.
**Anchor**: Ask regularly: "Am I refining what I know, or exploring what I don't?" Protect time for the second.
**See also**: [[curiosity-loops]], [[playfulness]], [[growth-orientation]]
