...
keywords: [ethics, decisions, principles, embedded, alignment]
definition: "Embeds ethics into decision-making."
tags:
  - type/quality
---
...
- [[identity-alignment]] — identity alignment is values integration at the identity level: "I am someone who acts from these values"
- [[meaning-coherence]] — meaning is coherent when action is values-congruent; integration is the mechanism

## Sources
- *needs sources*

## Recall
**Hook**: Values on a wall are decorative. Values in decisions are architecture.
**Mechanism**: When values are embedded into decision structure rather than invoked as abstract principles, they reduce the cognitive overhead of choice and prevent the behavioral drift that generates dissonance.
**Anchor**: If you have to re-consult your values before every significant decision, they're not yet integrated. Integration means the values are already present in the moment of choice.
**See also**: [[internal-alignment]], [[integrity-loops]], [[values-behavior-gap]]
